...
// Description: circle oscillating and changing size, mapped on the amplitude of music
...
void draw() {
  ...
  //saveFrame(); // only for exporting each frame, can be compiled using Movie Maker built into the processing environment
}
//----------------------------------------------------------------------------
